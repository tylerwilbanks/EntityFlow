...
class SystemAnnotationTests {
    ...
    fun systemHasNoAnnotation() {
        try {
            ...
            Assert.assertTrue(e is IllegalArgumentException)
            Assert.assertEquals(e.message, "The System class must be annotated with ${AllOfComponents::class.simpleName}, ${NoneOfComponents::class.simpleName}, or ${AnyComponents::class.simpleName}.")
        }
    }
}